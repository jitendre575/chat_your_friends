    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-primary/20 via-background to-background overflow-hidden relative">
      ...
      <div className="w-full max-w-lg space-y-10 relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-1000">
        ...
        <div className="grid grid-cols-1 gap-6">
          ...
          {/* Feature Section Demo Card */}
          <button
            onClick={() => router.push('/demo-features')}
            className="group relative flex items-center gap-6 p-8 rounded-[2.5rem] bg-white/10 border-2 border-white/5 hover:border-white/20 backdrop-blur-2xl transition-all duration-500 overflow-hidden shadow-2xl hover:shadow-white/5 hover:-translate-y-1 active:scale-[0.98] text-left"
          >
            <div className="absolute inset-0 bg-gradient-to-br from-white/5 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />

            <div className="relative flex items-center justify-center w-20 h-20 rounded-[1.5rem] bg-white/5 border border-white/10 text-white group-hover:bg-white group-hover:text-black transition-all duration-500 group-hover:scale-110 shadow-xl">
              <Zap size={40} strokeWidth={2.5} />
            </div>

            <div className="relative flex-1">
              <h2 className="text-2xl font-black text-white uppercase italic tracking-tight group-hover:text-white transition-colors">
                New Features Section
              </h2>
              <p className="text-muted-foreground text-sm font-medium mt-1 leading-tight">
                View the modern, responsive 4-box feature section demo
              </p>
            </div>
